...
class scoring_model(nn.Module):
    ...
    def forward(self,given_panels_feats,given_panels_pos, answer_panels_feats, answer_panels_pos, device):
        ...
        for d in range(answer_panels_feats.shape[1]):
            ...
            score = self.abstractors(x_seq,pos_seq+all_posemb_concat_flatten, device)
