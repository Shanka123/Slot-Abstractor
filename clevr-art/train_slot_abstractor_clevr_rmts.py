import os
import argparse
from slot_abstractor_clevr import *
import time
import datetime
...
parser.add_argument('--model_name', type=str, default='slot_attention_random_spatial_clevrshapes_cv2_rgbcolororder_pretrained_frozen_autoencoder_abstractor_scoring')
...
slot_model = load_slot_checkpoint(slot_model,'slot_attention_autoencoder_7slots_clevrdecoder_morewarmup_lowerlr_nolrdecay_64dim_128res_cv2_rgbcolororder_random_spatial_clevrshapes_continuetraining_run_1_best.pth.tar')
